...
class MODELNLSMAC:
    ...
    def forward_global_action(self, ep_batch, obs_emb, t, task, test_model=False):
        ...
        act_out, self.hidden_states_dec, self.hidden_states_plan = self.agent.forward_action(
            agent_inputs, obs_emb, self.hidden_states_dec, self.hidden_states_plan, task, t=t)
